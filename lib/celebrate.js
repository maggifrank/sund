...
export function attachTapHaptics(button) {
  ...
  tick.type = 'checkbox';
  tick.setAttribute('switch', '');
  tick.className = 'haptic-switch';
  /* The button is still the control: this is a texture laid over it, and a
     screen reader or a keyboard must never find it. */
